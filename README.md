...
a. Who are the people booking?
b. Which of our customers are canceling their bookings?
c. Where do we have the most bookings?
d. Out of the total bookings, how many were successful and unsuccessful?
## Key Performance Indicators (KPIs)
We also defined metrics and KPIs that will help answer the business questions. Examples include:
a. Total booking
b. Total cancellation/cancellation rate
c. Successful booking: Total booking where the reservation status is checked out. Unsuccessful booking: Total booking where the reservation status is canceled or no show.
## Dataset
